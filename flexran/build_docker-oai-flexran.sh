...
CONTNAME=oai-flexran
IMGNAME=oai-flexran-image
RELEASE=16.04
...
usage() {
    ...
    echo
    echo "  -c|--containername <name> (default: oai-flexran)"
    echo "  -i|--imagename <name> (default: oai-flexran)"
    rm_builddir
}
...
$SUDO docker exec -it $CONTNAME /bin/bash -c "snap install flexran --channel=edge --devmode"
