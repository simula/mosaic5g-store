# Overview OAI NFV SIM

This bundle defines a service templates to simulate a vLTE composed of vRAN and vEPC VNFs based on the OpenAirInterface (OAI).

It makes use of the following charms: MYSQL, HSS, EPC, OAISIM-ENB-UE.
